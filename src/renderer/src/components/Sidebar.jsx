...
import { IoLogOutOutline, IoPersonAddOutline, IoList, IoSettingsOutline } from "react-icons/io5";
...
export const Sidebar = () => {
  ...
  const [modalShowBackup, setModalShowBackup] = useState()
  ...
  return (
    <>
      ...
      <ModalDefault modalShow={modalShowBackup} setModalShow={setModalShowBackup} headerTitle="Fazer Backup" bodyMessage={"Você quer fazer o backup?"} btnConfirm={() => handleBackup()} btnConfirmText={'Fazer Backup'} />
      <div className="w-3/12 h-full bg-zinc-900 border-zinc-800 border-r flex flex-col items-center justify-start text-zinc-100">
        ...
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <SidebarItem value={'Configurações'} icon={<IoSettingsOutline size={22} />} onClick={() => navigate('/settings')} />
          <SidebarItem value={'Backup'} icon={<MdOutlineBackup size={22} />} onClick={() => setModalShowBackup(true)} />
        </div>
