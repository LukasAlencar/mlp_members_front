...
export const Sidebar = () => {
  ...
  return (
    <>
      <Modal modalShow={modalShow} setModalShow={setModalShow} headerTitle="Sair" bodyMessage={"Você tem certeza que deseja sair?"} btnDanger={()=>navigate('/')} btnDangerText={'Sair'}/>
      <div className="w-3/12 h-full bg-zinc-900 flex flex-col items-center justify-start">
        ...
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <SidebarItem value={'Lista de Membros'} icon={<IoList size={22} />} onClick={() => navigate('/')} />
        </div>
        <div className="flex-1 flex items-end pb-2 justify-start w-full">
