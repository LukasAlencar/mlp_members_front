...
export const MembershipCard = ({ member }) => {
  ...
  return (
    <div id="card" ref={handleDownloadPdf} onClick={handleDownloadPdf} key={member.id} className="w-[720px] h-[400px] bg-zinc-50 rounded-lg text-zinc-900 flex flex-col overflow-hidden">
