...
export const ModalDefault = ({ headerTitle, bodyMessage, btnDanger, btnConfirm, btnDangerText, btnConfirmText, modalShow, setModalShow}) => {
  ...
  return (
    <div
      ...
      className="absolute text-zinc-100 w-screen h-screen z-10 bg-zinc-950/90 top-0 left-0 flex justify-center items-center"
    >
      <div
      ...
      >
        <header className='mb-3 relative'>
          ...
          <IoMdClose onClick={() => setModalShow(false)} className='absolute top-1 right-1 cursor-pointer text-zinc-100' />
        </header>
        <HorizontalDivider />
